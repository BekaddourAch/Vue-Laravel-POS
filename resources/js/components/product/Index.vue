                    ...
                    <tbody>
                      <tr  v-for="product in searchFilter" :key="product.id"> 
                        ...
                        <td><img :src="product.image" alt="" id="imgtab"></td> 
                          <td><router-link class="btn btn-sm btn-primary" :to="{ name: 'editproduct', params: {id:product.id }} ">ُEdit</router-link>  -->
                          <a @click="deleteproduct(product.id)" class="btn btn-sm btn-danger">Delete</a></td>
                      </tr>
