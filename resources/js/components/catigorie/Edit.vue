            ...
            <div class="col-sm-10">
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Edit Catigories</h6>
                    </div>
                    <div class="card-body">
...
export default {
    ...
    methods: {
        ...
        supplierUpdate() {
            ...
            axios.patch('/api/catigorie/'+id, this.form)
              .then(() => {
                  this.$router.push({ name: 'allcatigories' })
