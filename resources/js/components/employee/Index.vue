                    ...
                    <tbody>
                      <tr  v-for="employee in searchFilter" :key="employee.id"> 
                        ...
                        <td><img :src="employee.photo" alt="" id="imgtab"></td> 
                          <td><router-link class="btn btn-sm btn-primary" :to="{ name: 'editemployee', params: {id:employee.id }} ">ُEdit</router-link>  -->
                          <a @click="deleteEmployee(employee.id)" class="btn btn-sm btn-danger">Delete</a></td>
                      </tr>
