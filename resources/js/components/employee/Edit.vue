                        ...
                        <form @submit.prevent="employeeUpdate" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" name="form.sallery" v-model="form.sallery"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="date" class="form-control" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" name="form.joining_date" v-model="form.joining_date"
                                            placeholder="Enter Joining dat" />
                                        <!-- <small id="emailHelp" class="form-text text-muted">{{ errors.joining_date[0]}}</small> -->
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="exampleInputEmail1"
                                            aria-describedby="emailHelp" name="form.nid" v-model="form.nid"
